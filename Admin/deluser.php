...
{
	$cn=makeconnection();
	$s="delete from donarregistration where email='"  . $_POST["s2"] ."'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<tr><td colspan="2" align="center" class="toptd">DELETE Donor</td></tr>
...
{
$cn=makeconnection();
$s="select * from donarregistration where email='" .$_POST["s2"] ."'";
	$result=mysqli_query($cn,$s);
	$r=mysqli_num_rows($result);
	//echo $r;
