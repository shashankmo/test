...
<tr><td class="lefttd">Donor Name:</td><td><input value="heyyy" type="text" name="t1" required="required" pattern="[a-zA-Z _]{4,15}" title="please enter only character  between 4 to 15 for donor name" /></td></tr>
...
<tr><td class="lefttd"> Wish to donate </td><td><fieldset>
<p>
             <select name="t8" id ="">
...
<tr><td class="lefttd">Previously Donated Date</td><td><input type="text" id="datepicker" name="t9" required="required"  /></td></tr>
...
if(isset($_POST["sbmt"])) 
{
		...
		$cn=makeconnection();
			$s="insert into donarregistration(name,gender,age,mobile,b_id,email,pwd,`wish_to_donate`, `prev_donated`) values('" . $_POST["t1"] ."','" . $_POST["r1"] . "','" . $_POST["t2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $_POST["t6"] .  "','" . $_POST["t8"] .  "','" . $_POST["t9"] .  "')";
	...
	mysqli_close($cn);
	  ...
	  echo '<script>window.location.href = "login_Firsttime.php";</script>';
